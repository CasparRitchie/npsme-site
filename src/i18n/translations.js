...
export const TRANSLATIONS = {
  en: {
    ...
    workspaceClosingLoop: {
      ...
      errors: { create: "Could not start the follow-up.", update: "Could not update the follow-up.", note: "Could not save the note.", events: "Could not load the timeline.", noteRequired: "Write a note before saving." },
    },
    envola: {
      seo: {
  ...
  items: [
    ...
    workspaceClosingLoop: {
      ...
      errors: { create: "Impossible de démarrer le suivi.", update: "Impossible de mettre à jour le suivi.", note: "Impossible d’enregistrer la note.", events: "Impossible de charger l’historique.", noteRequired: "Rédigez une note avant de l’enregistrer." },
    },
    envola: {
      seo: {
