...
// - Minimal, modern, professional, friendly, futuristic
// - Uses a purple + bright green accent on a deep slate background
// - Sections: Hero, 4-Stage Method, Outcomes, About, CTA Footer
      ...
      <header className="sticky top-0 z-20 backdrop-blur supports-[backdrop-filter]:bg-white/5 bg-black/10 border-b border-white/10">
        <div className="mx-auto max-w-7xl px-6 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm text-slate-300">
            ...
            <a href="#intake" className="hover:text-white">
              Intake
            </a>
          </nav>
          <a
          ...
          <div className="md:col-span-7 lg:col-span-6">
            ...
            <div className="mt-10 flex items-center gap-6 text-sm text-slate-400">
              <div className="flex items-center gap-2">
                <Star className="h-4 w-4" /> Review mining
              </div>
              <div className="flex items-center gap-2">
                <Wrench className="h-4 w-4" /> Hands-on enablement
              </div>
              <div className="flex items-center gap-2">
                <LineChart className="h-4 w-4" /> Measurable lift
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="demo" className="mx-auto max-w-7xl px-6 pb-20">
        <div className="rounded-3xl border border-white/10 bg-white/5 p-6">
          ...
          <p className="mt-2 text-slate-300">
            Rate us 0–10 and leave an optional comment. We’ll show a rolling demo NPS on this page.
          </p>
          <DemoWidget />
        </div>
      </section>
