...
export const TRANSLATIONS = {
  en: {
    ...
    routes: {
      ...
      customerFeedbackWorkspace: "Customer Feedback Workspace",
      impact: "Impact",
      workspace: "Workspace",
      workspaceImport: "Import feedback",
      workspaceDatasets: "Saved datasets",
      npsExplorer: "NPS Explorer",
      privacy: "Privacy",
      terms: "Terms",
      blogClosingTheLoop: "Closing the loop",
      blogEthicalSurveys: "Ethical surveys",
      blogEthicsOfContactSelection: "Ethics of contact selection",
      blogWhatToDoWithNpsScores: "What to do with NPS scores",
      blogDataVisualisation: "Data visualisation & CX insights",
    },
    about: {
    ...
    landing: {
      ...
      demo: {
        ...
        loading: "Loading demo summary…",
        error: "Demo summary unavailable",
        empty: "No demo responses yet",
      },
      ...
      explainer: {
        ...
        cautionsTitle: "A few important cautions:",
        cautions: [
      ...
      offers: [
        ...
        },
        {
          ...
          bullets: [
            ...
            "Ongoing improvement of the feedback process",
          ],
      ...
      comparison: {
        ...
        rows: [
          ...
          },
          {
            ...
            foundations: "2–4 week setup project",
            embedded: "Monthly or ongoing support",
          },
          {
            topic: "Data sources",
    ...
    workspaceClosingLoop: {
      ...
      subtitle: "Prioritise customer follow-up and keep every next action visible.",
      loading: "Loading customer follow-up…",
      statuses: { no_case: "No follow-up started", open: "New", in_progress: "Following up", closed: "Resolved" },
      priorities: { high: "High", normal: "Normal", low: "Low", not_set: "Not set" },
      buckets: { detractor: "Detractor", passive: "Passive", promoter: "Promoter", unknown: "Unknown" },
      summary: { total: "Responses", noCase: "Follow-up not started", open: "New", inProgress: "Following up", closed: "Resolved", openDetractors: "Detractors to follow up", highPriority: "High priority", unassigned: "Unassigned" },
      overview: { title: "Management overview", subtitle: "Follow-up progress and customers who need attention first.", hide: "Hide overview", show: "Show overview", statusTitle: "Follow-up progress", statusSubtitle: "A simple view from new response to resolved follow-up.", noCaseHint: "responses have no follow-up yet.", urgentTitle: "Needs attention first", urgentSubtitle: "The highest-risk unresolved follow-ups to work on first.", noneUrgent: "No unresolved follow-up needs attention.", view: "View customer response" },
      queue: { eyebrow: "Daily follow-up queue", title: "Customers to follow up", showing: "Showing", of: "of", response: "response", responses: "responses", empty: "No responses match these filters", clearFilters: "Clear filters", priority: "Priority", score: "Score", customerResponse: "Customer response", theme: "Primary theme", noTheme: "No theme detected", recommendation: "Recommendation", context: "Context", owner: "Owner", progress: "Progress", activity: "Last activity", actions: "Next action", unassigned: "Unassigned", noComment: "No comment provided.", earlierHistory: "Earlier follow-up history", view: "View customer response", intercom: "Open Intercom", start: "Start follow-up", continue: "Continue follow-up", all: "All", bucketFilter: "Filter by NPS group", ownerFilter: "Filter by owner", statusFilter: "Filter by progress", sortAscending: "Sort ascending", sortDescending: "Sort descending" },
      themes: { onboarding: "Onboarding", wifi: "Connectivity / WiFi", support: "Support speed", billing: "Billing", reliability: "Reliability / bugs", attendance_sheet: "Attendance sheet", time_tracking: "Hours & tracking", lateness: "Lateness / punctuality", parents: "Parents relationship", setup: "Setup & onboarding", feature_requests: "Feature requests", support_speed: "Support responsiveness" },
      themeSection: { title: "Themes", empty: "No themes detected in this response." },
      recommendations: { callToday: "Call today", messageToday: "Message today", followUp: "Follow up and ask what would improve", thank: "Thank them and ask for a referral", review: "Review response" },
      detail: { eyebrow: "Customer workspace", score: "Score", noDate: "No date", contact: "Contact customer in Intercom", feedback: "Customer feedback", feedbackHelp: "The complete survey response, kept together for context.", loading: "Loading complete response…", timeline: "Timeline", timelineHelp: "What has happened since this feedback was received.", timelineEmpty: "Start follow-up to create the first timeline event.", nextAction: "Next action", noFollowUp: "No follow-up started", noFollowUpHelp: "Start a follow-up so this customer has a visible owner and next step.", start: "Start follow-up", moveFollowing: "Mark as following up", resolve: "Resolve follow-up", reopen: "Reopen follow-up", notes: "Notes", notePlaceholder: "Record what happened, the proposed solution, or what the customer said…", saveNote: "Save note", saving: "Saving…", owner: "Owner", priority: "Priority", reminder: "Reminder", reminderHelp: "Reminder scheduling will live here in the next stage.", reminderUnavailable: "Scheduling not available yet", legacy: "Legacy history", legacyHelp: "Earlier follow-up records kept for reference.", noLegacy: "No earlier history.", replyTools: "Reply tools", replyHelp: "Create and review a suggested French Intercom reply.", generate: "Generate reply draft", generating: "Generating…", copy: "Copy draft", copied: "Copied", noDraft: "No draft generated yet.", draftNotice: "Review every suggested reply before sending it.", intercom: "Open Intercom", caseOpened: "Follow-up started", noteAdded: "Note added", statusChanged: "Progress updated", ownerChanged: "Owner updated", priorityChanged: "Priority updated", event: "Follow-up activity", noQuestions: "No question-level scores or comments were found.", question: "Question", comment: "Comment", recommendation: "Recommendation", installation: "Installation and getting started", dailyUse: "Daily use", benefits: "Benefits selected", parentRelation: "Parent relationship impact", support: "Support", finalComment: "Final comment", overallNps: "Overall NPS", headlineScore: "Headline score", additionalComment: "Additional comment" },
      errors: { create: "Could not start the follow-up.", update: "Could not update the follow-up.", note: "Could not save the note.", events: "Could not load the timeline.", noteRequired: "Write a note before saving.", closureNoteRequired: "Record the outcome in Notes before resolving this follow-up." },
    },
    envola: {
      seo: {
      ...
      closingTheLoop: {
        ...
        migration: {
          title: "Closing the Loop is moving to Workspace",
          body: "Use the Workspace version for the current customer follow-up experience. This Envola page remains available during migration.",
          action: "Open Workspace Closing the Loop",
        },
  ...
  fr: {
    ...
    routes: {
      ...
      customerFeedbackWorkspace: "Espace feedback client",
      impact: "Impact",
      workspace: "Espace de travail",
      workspaceImport: "Importer du feedback",
      workspaceDatasets: "Datasets enregistrés",
      npsExplorer: "Explorateur NPS",
      privacy: "Confidentialité",
      terms: "Conditions",
      blogClosingTheLoop: "Boucler la boucle",
      blogEthicalSurveys: "Enquêtes éthiques",
      blogEthicsOfContactSelection: "Éthique de la sélection des contacts",
      blogWhatToDoWithNpsScores: "Que faire avec vos scores NPS",
      blogDataVisualisation: "Data visualisation & insights CX",
    },
    about: {
  ...
  items: [
      ...
      offers: [
        ...
        },
        {
          ...
          bullets: [
            ...
            "Amélioration continue du processus de feedback",
          ],
    ...
    workspaceClosingLoop: {
      eyebrow: "Espace NPS Me",
      title: "Suivi client",
      subtitle: "Priorisez les relances clients et gardez chaque prochaine action visible.",
      loading: "Chargement du suivi client…",
      statuses: { no_case: "Aucun suivi démarré", open: "Nouveau", in_progress: "Suivi en cours", closed: "Résolu" },
      priorities: { high: "Haute", normal: "Normale", low: "Basse", not_set: "Non définie" },
      buckets: { detractor: "Détracteur", passive: "Passif", promoter: "Promoteur", unknown: "Inconnu" },
      summary: { total: "Réponses", noCase: "Suivi non démarré", open: "Nouveaux", inProgress: "Suivis en cours", closed: "Résolus", openDetractors: "Détracteurs à relancer", highPriority: "Priorité haute", unassigned: "Non attribués" },
      overview: { title: "Vue d’ensemble", subtitle: "L’avancement des suivis et les clients à traiter en priorité.", hide: "Masquer la vue", show: "Afficher la vue", statusTitle: "Avancement des suivis", statusSubtitle: "Une vue simple, de la nouvelle réponse au suivi résolu.", noCaseHint: "réponses n’ont pas encore de suivi.", urgentTitle: "À traiter en priorité", urgentSubtitle: "Les suivis non résolus présentant le risque le plus élevé.", noneUrgent: "Aucun suivi non résolu ne nécessite d’attention.", view: "Voir la réponse client" },
      queue: { eyebrow: "File de suivi quotidienne", title: "Clients à suivre", showing: "Affichage de", of: "sur", response: "réponse", responses: "réponses", empty: "Aucune réponse ne correspond à ces filtres", clearFilters: "Effacer les filtres", priority: "Priorité", score: "Note", customerResponse: "Réponse client", theme: "Thème principal", noTheme: "Aucun thème détecté", recommendation: "Recommandation", context: "Contexte", owner: "Responsable", progress: "Avancement", activity: "Dernière activité", actions: "Prochaine action", unassigned: "Non attribué", noComment: "Aucun commentaire.", earlierHistory: "Historique de suivi antérieur", view: "Voir la réponse client", intercom: "Ouvrir Intercom", start: "Démarrer le suivi", continue: "Continuer le suivi", all: "Tous", bucketFilter: "Filtrer par groupe NPS", ownerFilter: "Filtrer par responsable", statusFilter: "Filtrer par avancement", sortAscending: "Trier par ordre croissant", sortDescending: "Trier par ordre décroissant" },
      themes: { onboarding: "Onboarding", wifi: "Connexion / WiFi", support: "Rapidité du support", billing: "Facturation", reliability: "Fiabilité / bugs", attendance_sheet: "Fiche de présence", time_tracking: "Heures et pointage", lateness: "Retards / ponctualité", parents: "Relation parents", setup: "Installation et prise en main", feature_requests: "Demandes d’ajouts", support_speed: "Réactivité support" },
      themeSection: { title: "Thèmes", empty: "Aucun thème détecté dans cette réponse." },
      recommendations: { callToday: "Appeler aujourd’hui", messageToday: "Envoyer un message aujourd’hui", followUp: "Relancer et demander ce qui améliorerait l’expérience", thank: "Remercier et demander une recommandation", review: "Examiner la réponse" },
      detail: { eyebrow: "Espace client", score: "Note", noDate: "Sans date", contact: "Contacter le client dans Intercom", feedback: "Retour client", feedbackHelp: "La réponse complète à l’enquête, réunie pour garder le contexte.", loading: "Chargement de la réponse complète…", timeline: "Historique", timelineHelp: "Ce qui s’est passé depuis la réception de ce retour.", timelineEmpty: "Démarrez le suivi pour créer le premier événement.", nextAction: "Prochaine action", noFollowUp: "Aucun suivi démarré", noFollowUpHelp: "Démarrez un suivi pour attribuer ce client et rendre la prochaine étape visible.", start: "Démarrer le suivi", moveFollowing: "Passer en suivi en cours", resolve: "Résoudre le suivi", reopen: "Rouvrir le suivi", notes: "Notes", notePlaceholder: "Notez ce qui s’est passé, la solution proposée ou la réponse du client…", saveNote: "Enregistrer la note", saving: "Enregistrement…", owner: "Responsable", priority: "Priorité", reminder: "Rappel", reminderHelp: "La planification des rappels apparaîtra ici à la prochaine étape.", reminderUnavailable: "Planification bientôt disponible", legacy: "Historique antérieur", legacyHelp: "Les anciens suivis sont conservés pour référence.", noLegacy: "Aucun historique antérieur.", replyTools: "Outils de réponse", replyHelp: "Créez puis relisez une suggestion de réponse Intercom en français.", generate: "Générer une réponse", generating: "Génération…", copy: "Copier la réponse", copied: "Copiée", noDraft: "Aucune réponse générée.", draftNotice: "Relisez toujours la suggestion avant de l’envoyer.", intercom: "Ouvrir Intercom", caseOpened: "Suivi démarré", noteAdded: "Note ajoutée", statusChanged: "Avancement mis à jour", ownerChanged: "Responsable modifié", priorityChanged: "Priorité modifiée", event: "Activité de suivi", noQuestions: "Aucune note ou aucun commentaire détaillé n’a été trouvé.", question: "Question", comment: "Commentaire", recommendation: "Recommandation", installation: "Installation et prise en main", dailyUse: "Utilisation quotidienne", benefits: "Bénéfices sélectionnés", parentRelation: "Impact sur la relation parent", support: "Accompagnement", finalComment: "Commentaire final", overallNps: "NPS global", headlineScore: "Note principale", additionalComment: "Commentaire complémentaire" },
      errors: { create: "Impossible de démarrer le suivi.", update: "Impossible de mettre à jour le suivi.", note: "Impossible d’enregistrer la note.", events: "Impossible de charger l’historique.", noteRequired: "Rédigez une note avant de l’enregistrer.", closureNoteRequired: "Notez le résultat dans Notes avant de résoudre ce suivi." },
    },
    envola: {
      seo: {
      ...
      closingTheLoop: {
        ...
        migration: {
          title: "Le suivi client migre vers l’Espace de travail",
          body: "Utilisez la version Espace de travail pour l’expérience actuelle de suivi client. Cette page Envola reste disponible pendant la migration.",
          action: "Ouvrir le suivi client dans l’Espace de travail",
        },
        ...
        modal: {
          ...
          sent: "Envoyé",
          responded: "Répondu",
          surveyDetail: "Détail de la réponse",
        },
      },
