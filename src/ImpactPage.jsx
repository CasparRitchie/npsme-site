...
export default function ImpactPage() {
  ...
  return (
    <section id="impact" className="mx-auto max-w-7xl px-6 pb-20">
      <Seo
        path="/impact"
        title="CX Impact Calculator: Estimate NPS, churn and support savings | NPS Me"
        description="Simple calculator to estimate gross profit impact from repeat purchase lift, churn reduction, and support ticket savings when you improve customer experience."
      />
