...
export const ROUTES_MANIFEST = [
  ...
  {path: "/customer-feedback-workspace",                        label: "Customer Feedback Workspace",  labelKey: "routes.customerFeedbackWorkspace",  enabled: true,  indexable: true,  inHeader: true,  inFooter: true,  lang: "en",},
  { path: "/fr/customer-feedback-workspace",                    label: "Espace feedback client",  labelKey: "routes.customerFeedbackWorkspace",  enabled: true,  indexable: true,  inHeader: true,  inFooter: true,  lang: "fr",},
