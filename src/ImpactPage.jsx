 ...
 * - Minimal dependencies (no charts), Tailwind classes match your site.
      ...
      <div className="rounded-3xl border border-white/10 bg-white/5 p-6 md:p-10">
        ...
        <div className="mt-8 rounded-2xl border border-white/10 bg-black/30 p-5 text-sm text-slate-300 space-y-2">
          ...
          <ul className="list-disc pl-5 space-y-1">
            <li>
              <span className="text-white">Repeat revenue added</span> ≈ monthly revenue × repeat-rate lift%.
            </li>
            <li>
              <span className="text-white">Churn revenue saved</span> ≈ monthly revenue × churn-reduction%.
            </li>
            <li>
              <span className="text-white">Support savings</span> = (orders × tickets/1k × reduction%) × cost/ticket.
            </li>
            <li>
              <span className="text-white">Gross profit impact</span> = (added + saved) × gross margin + support savings.
            </li>
          </ul>
...
function Kpi({ label, value, note, highlight = false }) {
  return (
    <div className={`rounded-2xl border border-white/10 p-5 ${highlight ? "bg-gradient-to-br from-[#141B2E] to-[#0F172A]" : "bg-black/20"}`}>
