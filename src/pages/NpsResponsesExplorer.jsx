...
export default function NpsResponsesExplorer() {
  ...
  return (
    <div className="p-6">
      ...
      <div className="overflow-auto border border-slate-300 rounded bg-slate-100">
        <table className="min-w-[2600px] text-xs">

          <thead className="bg-[#0F172A] text-slate-100 text-[11px] uppercase tracking-wide">
            <tr>
              <th className="sticky left-0 bg-[#0F172A] p-2 w-[180px]">Contact</th>
              <th className="sticky left-[180px] bg-[#0F172A] p-2 w-[120px]">Date</th>
              <th className="sticky left-[300px] bg-[#0F172A] p-2 w-[220px]">Response ID</th>
          ...
          <tbody>
            {rows.map((r, i) => (
              ...
              >
                <td className="sticky left-0 bg-slate-100 p-2 break-words text-slate-900 leading-snug">
                  <a
                ...
                <td className="sticky left-[180px] bg-slate-100 p-2 text-slate-900 leading-snug">
                  {new Date(r.submitted_at).toLocaleDateString()}
                </td>

                <td className="sticky left-[300px] bg-slate-100 p-2 break-all text-slate-900 leading-snug">
                  {r.response_id}
                </td>
                ...
                <td className="p-2 break-words text-slate-900 leading-snug">{r.pioupiou}</td>
                <td className="p-2 break-words text-slate-900 leading-snug">{r.reader_serial}</td>

                <td className="p-2 text-slate-900">{r.q_recommend_score}</td>
                <td className="p-2 whitespace-normal break-words text-slate-900 leading-snug">
                  {r.q_recommend_comment}
                </td>

                <td className="p-2 text-slate-900">{r.q_install_score}</td>
                <td className="p-2 whitespace-normal break-words text-slate-900 leading-snug">
                  {r.q_install_comment}
                </td>

                <td className="p-2 text-slate-900">{r.q_daily_use_score}</td>

                <td className="p-2 whitespace-normal break-words text-slate-900 leading-snug">
                  {r.q_benefits}
                </td>

                <td className="p-2 text-slate-900">{r.q_parent_relation_score}</td>
                <td className="p-2 whitespace-normal break-words text-slate-900 leading-snug">
                  {r.q_parent_relation_comment}
                </td>

                <td className="p-2 text-slate-900">{r.q_support_score}</td>
                <td className="p-2 whitespace-normal break-words text-slate-900 leading-snug">
                  {r.q_final_comment}
                </td>
